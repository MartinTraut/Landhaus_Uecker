  ...
  return (
    ...
    >
      <div
        ...
        style={{ height: Math.max(260, cardHeight + 80) }}
        tabIndex={0}
        onKeyDown={onKeyDown}
      >
        <div
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
              ...
              return (
                <button
                  ...
                  className={cn(
                    ...
                    on
                      ? "bg-forest-700"
                      : "bg-warm-800/30 hover:bg-warm-800/50",
                  )}
          ...
          {activeItem.href ? (
            <Link
              ...
              target="_blank"
              rel="noreferrer"
              className="text-warm-800/50 hover:text-forest-700 transition"
  ...
  return (
    <div className="relative h-full w-full">
      ...
      <div className="relative z-10 flex h-full flex-col justify-end p-5">
        ...
        {item.description ? (
          <div className="mt-1 line-clamp-2 font-serif text-sm text-white/80">
            {item.description}
          </div>
        ) : null}
      </div>
